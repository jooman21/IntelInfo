...
public class UpdateFinanceOfficerProfileEvent <p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public UpdateFinanceOfficerProfileEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

...
public class MakeAllowedPaymentDecisionEvent <p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public MakeAllowedPaymentDecisionEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

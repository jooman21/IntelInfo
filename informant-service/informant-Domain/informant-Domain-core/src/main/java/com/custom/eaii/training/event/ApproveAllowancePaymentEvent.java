...
public class ApproveAllowancePaymentEvent <p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public ApproveAllowancePaymentEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

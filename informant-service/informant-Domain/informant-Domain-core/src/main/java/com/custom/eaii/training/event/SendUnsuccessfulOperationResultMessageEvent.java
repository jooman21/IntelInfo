...
public class SendUnsuccessfulOperationResultMessageEvent<p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public SendUnsuccessfulOperationResultMessageEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

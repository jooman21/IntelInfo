...
public class UpdateEmployeeProfileEvent <p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public UpdateEmployeeProfileEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

...
public class RemoveEmployeeProfileEvent <p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;


    public RemoveEmployeeProfileEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {

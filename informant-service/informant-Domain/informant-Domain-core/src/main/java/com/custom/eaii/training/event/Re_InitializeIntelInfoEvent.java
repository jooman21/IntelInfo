...
public class Re_InitializeIntelInfoEvent<p> implements DomainEvent<IntelInfo> {
    private final IntelInfo intelInfo;
    private final ZonedDateTime createdAt;

    public Re_InitializeIntelInfoEvent(IntelInfo intelInfo, ZonedDateTime createdAt) {
